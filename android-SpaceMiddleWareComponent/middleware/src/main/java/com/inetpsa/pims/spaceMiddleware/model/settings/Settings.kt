...
@Deprecated("This should ne replaced by dedicated brand model")
internal data class Settings(
    // fca settings
    val callCenterSettings: List<CallCenterSettingsFca?>? = null,
    // psa settings
    ...
    @SerializedName("sams.navco.url.enable") val samsNavcoEnabled: Boolean? = null,
    ...
    @SerializedName("assistance.rsa.phone") val assistanceRsaPhone: String? = null,
    ...
    @SerializedName("ws_sams_myaccount.url") val samsMyaccountUrl: String? = null,
    ...
    @SerializedName("clubv2") val clubV2Enable: Boolean? = null,
    ...
    @SerializedName("RemoteAcces") val remoteAccess: Int? = null,
    ...
    @SerializedName("hivebrite.url") val hivebriteUrl: String? = null,
    ...
    @SerializedName("urlVoyants") val urlVoyants: String? = null,
    ...
    internal data class CallCenterSettingsFca(
