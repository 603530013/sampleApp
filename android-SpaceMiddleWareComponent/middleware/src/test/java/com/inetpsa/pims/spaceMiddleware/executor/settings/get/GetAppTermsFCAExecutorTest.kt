...
internal class GetAppTermsFCAExecutorTest : FcaExecutorTestHelper() {
    ...
    private lateinit var executor: GetAppTermsFCAExecutor
    ...
    override fun setup() {
        ...
        executor = spyk(GetAppTermsFCAExecutor(baseCommand))
    }
