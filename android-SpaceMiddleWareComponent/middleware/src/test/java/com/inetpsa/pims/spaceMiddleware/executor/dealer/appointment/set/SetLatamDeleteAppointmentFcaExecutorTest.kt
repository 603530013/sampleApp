...
internal class SetLatamDeleteAppointmentFcaExecutorTest : FcaExecutorTestHelper() {

    private lateinit var executor: SetLatamDeleteAppointmentFcaExecutor
    ...
    private val response: DeleteDealerAppointmentResponse = DeleteDealerAppointmentResponse(
        "testDeleteId",
    ...
    override fun setup() {
        super.setup()
        executor = spyk(SetLatamDeleteAppointmentFcaExecutor(middlewareComponent))
    }
