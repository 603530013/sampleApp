...
internal class GetNaftaRepairServicesFcaExecutorTest : FcaExecutorTestHelper() {

    private lateinit var executor: GetNaftaRepairServicesFcaExecutor
    ...
    fun setUp() {
        ...
        executor = spyk(GetNaftaRepairServicesFcaExecutor(middlewareComponent))
    }
