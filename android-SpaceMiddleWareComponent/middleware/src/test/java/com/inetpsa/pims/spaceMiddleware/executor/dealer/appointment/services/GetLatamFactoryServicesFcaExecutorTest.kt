...
internal class GetLatamFactoryServicesFcaExecutorTest : FcaExecutorTestHelper() {

    private lateinit var executor: GetLatamFactoryServicesFcaExecutor
    ...
    fun setUp() {
        ...
        executor = spyk(GetLatamFactoryServicesFcaExecutor(middlewareComponent))
        // coEvery { executor.saveOnCache(dealerServiceResponse) }
    }
