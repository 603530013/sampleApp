...
import com.inetpsa.pims.spaceMiddleware.sample.utils.Constants.LOCATIONS
...
@Deprecated("This should be replaced by the NewLocationsApi")
class LocationsApi : BaseApi() {

    /**
     * Api name
     */
    override val apiName: String = "$SERVICE_NAME.$LOCATIONS"
